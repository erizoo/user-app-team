...
<div>
    ...
    <a href="<c:url value='/login/facebook'/>">Login</a>
</div>
<div>
...
<div>
    ...
    <a href="<c:url value='/login/instagram'/>">Login</a>
</div>
<div>
    To logout with Instagram click link below:
    <a href="<c:url value='/logout/instagram'/>">Logout</a>
</div>
</br>
<div>
    To check current Instagram user use link below:
    <a href="<c:url value='/current-user'/>">Checking</a>
</div>
</body>
</html>
